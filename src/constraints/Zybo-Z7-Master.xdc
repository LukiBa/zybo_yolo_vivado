...
##Buttons
#set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { PE_rst }]; #IO_L12N_T1_MRCC_35 Sch=btn[0]
#set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { AXIS_rst }]; #IO_L24N_T3_34 Sch=btn[1]
#set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS33 } [get_ports { Rst_dma }]; #IO_L10P_T1_AD11P_35 Sch=btn[2]
...
set_false_path -from [get_clocks clk_out2_system_clk_wiz_1_0] -to [get_clocks PE_Clk_i]
set_false_path -from [get_clocks PE_Clk_i] -to [get_clocks clk_out2_system_clk_wiz_1_0]
set_false_path -from [get_clocks clk_out1_system_clk_wiz_1_0] -to [get_clocks m00_axis_aclk]
set_false_path -from [get_clocks m00_axis_aclk] -to [get_clocks clk_out1_system_clk_wiz_1_0]
set_false_path -from [get_clocks clk_out1_system_clk_wiz_1_0] -to [get_clocks s00_axis_aclk]
set_false_path -from [get_clocks s00_axis_aclk] -to [get_clocks clk_out1_system_clk_wiz_1_0]
